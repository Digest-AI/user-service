        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefreshTokensRevokedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("5a17334f-7431-4256-859a-9b2251ef7e22"), "Premium user role", "PREMIUMUSER" },
                    { new Guid("5e8e5f7a-0ba9-44d9-a9cc-b2c34d1821aa"), "Default user role", "USER" },
                    { new Guid("67d786a4-86fa-4e8e-b038-451c0b06f0f0"), "Administrator role", "ADMIN" }
                });
